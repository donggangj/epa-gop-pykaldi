...
def create_phone_weight_yaml(phone_weights_path, phone_count_dict, class_count_dict, phone_sym2int, phone_int2sym,
                             phone_thereshold, class_thereshold):
...
if __name__ == "__main__":
    ...
    for labels_file in glob.glob(labels_dir + "*/labels/*.txt"):
        ...
        phone_sym_count_dict = add_phone_count(phone_sym_count_dict, target_column, phone_sym2int,
                                               separate_pos_neg=True, labels=labels)

    create_phone_class_count_list(phone_sym_count_dict, phone_class_counts_path)
    create_phone_weight_yaml(phone_weights_path, phone_int_count_dict, phone_sym_count_dict, phone_sym2int,
                             phone_int2sym, phone_thereshold, class_thereshold)
