...
def get_phone_number_at_frame(labels, frame):
    ...
    #	embed()
    return res + 3  # This +3 is here because librispeech phones-pure starts with eps, sil, spn and these should be
    # skipped
...
def get_speaker_list_from_utterance_list_file(sample_list_path):
    speaker_list = []
    sample_list_fh = open(sample_list_path, "r")
    for line in sample_list_fh.readlines():
        line = line.split()
